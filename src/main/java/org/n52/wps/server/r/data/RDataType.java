...
public enum RDataType implements RTypeDefinition {
    ...
    // literal data:
    STRING("string", "xs:string", LiteralData.class),
    CHARACTER("character", "xs:string", LiteralData.class),
    INTEGER("integer", "xs:integer", LiteralData.class),
    DOUBLE("double", "xs:double", LiteralData.class),
    BOOLEAN("boolean", "xs:boolean", LiteralData.class),
    ...
    private Class< ? extends Data<?>> iDataClass;
    ...
    private RDataType(String key, String mimeType, Class< ? extends Data<?>> iDataClass, boolean isComplex) {
        this(key, mimeType, iDataClass, isComplex, null, null);
    }

    private RDataType(String key, String mimeType, Class< ? extends Data<?>> iDataClass) {
    ...
    @Override
    public Class< ? extends Data<?>> getIDataClass() {
