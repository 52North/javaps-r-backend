...
public class RResource {
    ...
    public ResponseEntity<Resource> getResource(@PathVariable(REQUEST_PARAM_SCRIPTID) String scriptId,
            @PathVariable(REQUEST_PARAM_RESOURCEID) String resourceId) throws OwsExceptionReport {
...
//                    e);
    ...
    public ResponseEntity<Resource> getScript(@PathVariable(REQUEST_PARAM_SCRIPTID) String id) throws OwsExceptionReport,
            IOException {
...
//            throw new ExceptionReport(e.getMessage(), ExceptionReport.NO_APPLICABLE_CODE);
    ...
    public ResponseEntity<Resource> getImport(@PathVariable(REQUEST_PARAM_SCRIPTID) String scriptId,
            @PathVariable(REQUEST_PARAM_RESOURCEID) String importId) throws OwsExceptionReport {
