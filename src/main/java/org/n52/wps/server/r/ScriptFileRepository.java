...
public class ScriptFileRepository {
    ...
    public String getWKNForScriptFile(File file) throws RAnnotationException, OwsExceptionReport {
//        if ( !file.exists())
//            throw new FileNotFoundException("File not found: " + file.getName());
    ...
    public boolean registerScriptFile(File file) throws RAnnotationException, OwsExceptionReport {
