...
public class RSessionManager {
    ...
    public void configureSession(String processWKN, RExecutor executor) throws OwsExceptionReport,
            RserveException,
...
//        loadWPSSessionVariables(processWKN);//TODO
//        loadUtilityScripts(executor);
    ...
    private void loadWPSSessionVariables(String processWKN) throws OwsExceptionReport {
...
//                                      e);
    ...
    public HashMap<String, Data<?>> saveInfos(HashMap<String, Data<?>> result) {
        try {
